...
4. While using flexbox, what axis does the following property work on: `align-items: center`?
   The cross axis. This is the axis opposite of the flex-direction.

5. Explain why git is valuable to a team of developers.

Git is a version control system. It allows developers to work on the same project all while being able to add, view, and discuss changes seamlessly. It makes collaborating on a project a lot easier.
